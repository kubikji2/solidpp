            ...
            rotate(_rot)
                ...
                difference()
                {
                    ...
                    if (__t_h > 0)
                    {
                        ...
                        _square_size = [2*__t_r,__t_h];
                        _circ_size = scale_vec(2,[__t_r,__t_h]);
                        
                        translate([__d2/2+_a,_h/2])
                        difference()
                        {
                    ...
                    if (__b_h > 0)
                    {
                        ...
                        _square_size = [2*__b_r,__b_h];
                        _circ_size = scale_vec(2,[__b_r,__b_h]);
                        
                        translate([__d1/2+_a,-_h/2])
                        difference()
                        {
                            squarepp(_square_size, align="y");
                            circlepp(_circ_size, align="Xy");
