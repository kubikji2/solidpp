...
function __solidpp__is_valid_round_bases_modifier(modifier) = 
    ...
    (
        is_undef(modifier[__ROUND_BASES_BOTTOM_3D_IDX]) ||
        is_vector_3D(modifier[__ROUND_BASES_BOTTOM_3D_IDX])
    )
    &&
    // - cylinder data are undef or vector 2D
    (
        is_undef(modifier[__ROUND_BASES_BOTTOM_2D_IDX]) ||
        is_vector_2D(modifier[__ROUND_BASES_BOTTOM_2D_IDX])
    )
    &&
    ...
    // - cube data are undef or vector 3D
    (
        is_undef(modifier[__ROUND_BASES_TOP_3D_IDX]) ||
        is_vector_3D(modifier[__ROUND_BASES_TOP_3D_IDX])
    )
    &&
    // - cylinder data are undef or vector 2D
    (
        is_undef(modifier[__ROUND_BASES_TOP_2D_IDX]) ||
        is_vector_2D(modifier[__ROUND_BASES_TOP_2D_IDX])
    )
    &&
    // - at least one cube and cylinder data must be defined
    (
